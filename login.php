                                    ...
                                    <form>
                                        ...
                                        <div class="col-md-20  mt-5">
                                            <div class="form-group">
                                                <input type="email" name="email" required id="form3Example1"
                                        ...
                                        <div class="col-md-20 mb-4 mt-4">
                                            <div class="form-group">
                                                <input type="password" name="password" required id="form3Example1"
                                                    class="form-control w-100" placeholder=" " />
                                        ...
                                        <div class="text-center pt-1 mb-5 pb-1">
                                            <button name="submit "
                                                class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3 pt-3 pb-3"
                                                type="button">Log
                                                in</button>
                                        ...
                                        <div class="d-flex align-items-center justify-content-center pb-4">
                                            ...
                                            <button type="button" class="btn btn-outline-danger mx-2">Create
                                                new</button>
                                        </div>
